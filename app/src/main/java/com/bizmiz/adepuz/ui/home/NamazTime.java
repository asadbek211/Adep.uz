...
public class NamazTime {
    ...
    public static PrayTimeModel getPrayTime(double latitude, double longitude, int timezone) {
        NamazTime prayers = new NamazTime();
        ...
        return new PrayTimeModel(prayerTimes.get(0), prayerTimes.get(1), prayerTimes.get(2), prayerTimes.get(3), prayerTimes.get(5), prayerTimes.get(6));
    }
